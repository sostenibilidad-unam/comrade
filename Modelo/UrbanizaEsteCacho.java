...
public class UrbanizaEsteCacho{
	 ...
	 * @param args
	 */
	public UrbanizaEsteCacho(String carpeta, int years, String gridInicial, int initialYear) {
	//leer las celdas del raster de bosques
		...
		try {
			...
			//String elUltimo = tail(new File (carpeta, "calibrando.txt"));
			String elUltimo = elMejorHastaAhora(new File (carpeta, "calibrando.txt"));
			System.out.println(elUltimo);
			
			parametros = elUltimo.split(", ");
...
//	    CA.freno_zona_federal= 50;
		...
		CA.quieroCrecerEscribiendo(years, carpeta, initialYear);

	}
	public UrbanizaEsteCacho(String carpeta, int years, String gridInicial, int initialYear, int[] parametros) {
	//leer las celdas del raster de bosques
