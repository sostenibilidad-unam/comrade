...
public class UrbanizandoFrenosBinario extends Automata {
...
//	public int numeroDeColumnas;
	...
	public UrbanizandoFrenosBinario(int numeroDeCeldasX, int numeroDeCeldasY, int numeroMaximoDeIteraciones, int estadosPosibles) {
