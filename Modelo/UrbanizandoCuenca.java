...
public class UrbanizandoCuenca extends Automata {
...
//	public int numeroDeColumnas;
	...
	public UrbanizandoCuenca(int numeroDeCeldasX, int numeroDeCeldasY, int numeroMaximoDeIteraciones, int estadosPosibles) {
    ...
    public void reglasDeTranciscion(int i,int j){
    	...
    	//if (elMisterioHumano.nextInt(100)>50){
    		...
    		if (eras == 0) {
    			...
    			}else if( (sumaRadio10 >= gregariedad) && (sumaMore <= privacidad) ){
